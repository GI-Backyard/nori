...
public:
    ...
    void uniformSample(const Point3f& sample, Point3f& position, Vector3f& normal, float& pdf) const;
...
protected:
    ...
    DiscretePDF* m_facepdf = nullptr;               ///< precomputed pmf based on face area for sampling
};
